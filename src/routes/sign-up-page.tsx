...
export function SignUpPage() {
  ...
  return (
    <AuthCard
      ...
      title="Start with email or let the server expose which social providers are live."
      description="The template keeps sign-up lean: one shared auth handler, one session system, and only the providers the backend says are configured."
      footer={
        <p>
          Already have an account?{" "}
          <Link to="/sign-in" className="font-semibold text-app-accent">
            Sign in
          </Link>
          .
        </p>
